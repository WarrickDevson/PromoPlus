...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *promoterplus.serverless*):

Restore dependencies
```
    cd "promoterplus.serverless"
    dotnet restore
```

Execute unit tests
```
    cd "promoterplus.serverless/test/promoterplus.serverless.Tests"
    dotnet test
```

Deploy application
```
    cd "promoterplus.serverless/src/promoterplus.serverless"
